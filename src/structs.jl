...
function Optimizer(args...; design_type=Optimize, model, design_list, parm_list, data_list,
    ...
    log_like = loglikelihood(model, design_grid, parm_grid, data_grid, model_type, model_state)
